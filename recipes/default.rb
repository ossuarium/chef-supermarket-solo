#
# Cookbook Name:: supermarket-solo
# Recipe:: default
#
...
node.default['supermarket']['host'] = node['fqdn']
node.default['supermarket']['force_ssl'] = true
node.default['supermarket']['ssl_crt_path'] = "/etc/ssl/private/#{node['fqdn']}.pem"
